...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        consumer_key        = 'b4TeH6rNxwohsVo3OJx4U4pgh'
        consumer_secret     = 'kFo3f5499tKybDCbswc8JO5ZdnE1Gt8DYs7ATBYuOMaNqURlh0'
        access_token        = '2393093018-BWxBC5vCE2NHm46t7Llxum9hSEJPtcqy4Xfg7Ui'
        access_token_secret = 'jVcKgZEtzEDKQWFQh9OGzXewdggangCdqZ64zgYTCHTmP'
...
def tweet_return(tweet_handle):
    ...
    tweet_path = "twitter_data/"+"tweets.csv"
